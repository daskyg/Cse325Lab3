  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  49:	78 20                	js     6b <main+0x6b>
    priority = 0;
  }

  //Locking to range
  if (priority > 39){
  4b:	83 f8 27             	cmp    $0x27,%eax
  4e:	7e 05                	jle    55 <main+0x55>
    priority = 39;
  50:	b8 27 00 00 00       	mov    $0x27,%eax
  }
  //Setting priority
  setpr(pid, priority);
  55:	52                   	push   %edx
  ...
  57:	50                   	push   %eax
  58:	56                   	push   %esi
  59:	e8 04 03 00 00       	call   362 <setpr>
  //Getting priority
  getpr(pid);
  5e:	89 34 24             	mov    %esi,(%esp)
  61:	e8 04 03 00 00       	call   36a <getpr>
  exit();
  66:	e8 57 02 00 00       	call   2c2 <exit>
    priority = 0;
  6b:	31 c0                	xor    %eax,%eax
  6d:	eb e6                	jmp    55 <main+0x55>
  6f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb b4 07 00 00       	mov    $0x7b4,%ebx
        while(*s != 0){
 ...
 601:	a1 68 0a 00 00       	mov    0xa68,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 68 0a 00 00       	mov    %eax,0xa68
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 68 0a 00 00    	cmp    %eax,0xa68
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 68 0a 00 00    	mov    0xa68,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 68 0a 00 00    	mov    %edx,0xa68
}
 ...
 757:	0a 00 00 
 75a:	c7 05 6c 0a 00 00 6c 	movl   $0xa6c,0xa6c
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 6c 0a 00 00       	mov    $0xa6c,%eax
 769:	c7 05 70 0a 00 00 00 	movl   $0x0,0xa70
 770:	00 00 00 
